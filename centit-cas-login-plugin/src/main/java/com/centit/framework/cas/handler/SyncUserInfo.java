...
public class SyncUserInfo {
    ...
    public void syncUser(Principal principal) {
        //判断同步人员、机构信息
        try (Connection conn = DbcpConnectPools.getDbcpConnect(syncUserProperties.getDatasource())) {
            ...
            if (null == unit) {
                ...
                saveUserInfo(syncUserProperties.getInsertUnitSql(), params);
            } else {
            ...
            if (null == user) {
                ...
                saveUserInfo(syncUserProperties.getInsertUserSql(), params);
            } else {
            ...
            if (userUnit == 0) {
                ...
                params.put("unitcode", unitcode);
                params.put("usercode", usercode);
                saveUserInfo(syncUserProperties.getInsertUserUnitSql(), params);
            }
        } catch (Exception e) {
